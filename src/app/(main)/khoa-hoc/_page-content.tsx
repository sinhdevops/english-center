          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-100">
                <th className="w-[10%] px-5 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                  STT
                </th>
                <th className="w-[20%] px-5 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                  Tên Khóa Học
                </th>
                <th className="w-[35%] px-5 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                  Chi Tiết
                </th>
                <th className="w-[10%] px-5 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                  Thời Gian
                ...
                <th className="w-[15%] px-5 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                  Đăng Ký
                </th>
              </tr>
            </thead>

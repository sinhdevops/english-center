...
export function KhoaHocTieuChuanPageContent() {
  return (
              ...
              return (
                ...
                >
                  <div className="relative z-10 text-left">
                    <div
                      className={`mb-8 flex h-16 w-16 items-center justify-center rounded-2xl border transition-all duration-500 group-hover:scale-110 ${
                        benefit.theme === 'primary'
                          ? 'text-stem-blue border-blue-100 bg-blue-50'
                  ...
                  <div
                    className={`absolute -right-4 -bottom-4 h-16 w-16 rounded-full opacity-0 transition-all duration-500 group-hover:opacity-10 ${
                      benefit.theme === 'primary' ? 'bg-stem-blue' : 'bg-emerald-400'
                    }`}
                  />
                </div>
              )
              ...
              <div className="space-y-8">
                {RIPL_METHODOLOGY.map((item, idx) => (
                  <div key={idx} className="group flex gap-6">
                    ...
                    <div>
                      <h5 className="font-heading mb-1 text-xl font-bold text-slate-900">{item.t}</h5>
              ...
              <div className="absolute top-1/2 -right-12 z-20 hidden md:block">
                <div className="rounded-2xl border border-slate-100 bg-white p-6">
                  ...
                  <p className="max-w-[200px] text-sm font-medium text-zinc-600 italic">
                    &ldquo;Phương pháp này giúp bé nhà mình tự tin nói tiếng Anh chỉ sau 3 tháng.&rdquo;
                  </p>

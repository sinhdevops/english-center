...
export default function PageContent() {
	...
	return (
		<>
			...
			<div className="mx-auto max-w-7xl space-y-25 py-20">
				<div className="grid grid-cols-1 items-center gap-12 px-4 lg:grid-cols-2 lg:gap-20">
					{/* Left: Content */}
				...
				<section className="px-4">
					<h2 className="mb-16 text-center text-3xl font-bold tracking-tight text-slate-900 uppercase">

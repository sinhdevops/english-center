...
interface ChuongTrinhPageContentProps {
  slug: string
}

export function ChuongTrinhPageContent({ slug }: ChuongTrinhPageContentProps) {
  const program = PROGRAMS_DETAIL_DATA[slug]
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 lg:py-12">
        <div className="flex flex-col gap-10 lg:flex-row">
          ...
          <div className="w-full lg:w-2/3">
            <div
              className="relative mb-8 aspect-20/11 overflow-hidden rounded-xl sm:aspect-16/7"
              style={program.style}
            >
          ...
          <div className="w-full space-y-8 lg:w-1/3">
            ...
            <div className="overflow-hidden rounded-4xl border border-slate-100 bg-white">
              <div className="border-b border-slate-50 p-5 px-8">

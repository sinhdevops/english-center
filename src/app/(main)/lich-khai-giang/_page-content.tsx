...
interface LichKhaiGiangPageContentProps {
  initialBranches: Branch[]
  initialSchedules: ScheduleWithJoin[]
}

export function LichKhaiGiangPageContent({ initialBranches, initialSchedules }: LichKhaiGiangPageContentProps) {
                      ...
                      {branchSchedules.length > 0 ? (
                        branchSchedules.map((schedule, idx) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-6 text-slate-500">{schedule.schedule}</td>

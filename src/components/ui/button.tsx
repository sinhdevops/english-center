...
export const Button: React.FC<ButtonProps> = ({
	...
	const variants = {
		primary: "bg-stem-blue text-white shadow-md shadow-blue-200 hover:bg-blue-600",
		secondary: "bg-stem-green text-white shadow-md shadow-green-200 hover:bg-green-600",

						...
						{user ? (
							<div className="relative">
								<button
									...
									className="group flex items-center gap-3 rounded-full border border-slate-100 bg-white p-1 pr-4 transition-all hover:border-slate-200 hover:"
								>
									...
									{showDropdown && (
										<>
											...
											<motion.div
												...
												exit={{ opacity: 0, y: 10 }}
												className="absolute right-0 z-50 mt-2 w-56 overflow-hidden rounded-2xl border border-slate-100 bg-white py-2"
											>

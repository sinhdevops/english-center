...
import { LayoutDashboard, CalendarDays, Trophy, Users, MapPin, BookOpen, ClipboardList, X, ImagePlay, FileText, ClipboardEdit } from "lucide-react";
...
const navItems = [
	...
	{ name: "Quản lý bài test", href: "/admin/quiz-sets", icon: ClipboardEdit },
];

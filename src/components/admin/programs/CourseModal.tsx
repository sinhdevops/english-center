			...
			<form onSubmit={handleSubmit} className="space-y-4">
				<AdminFormField label="Chương trình" error={errors.program_id} required>
					<select
						...
						className="mt-1 block w-full rounded-xl border border-slate-200 px-4 py-2.5 text-sm disabled:opacity-60"
				...
				<AdminFormField label="Mô tả ngắn" error={errors.description}>
					<textarea
						...
						rows={3}
						className="mt-1 block w-full resize-none rounded-xl border border-slate-200 px-4 py-2.5 text-sm"
					/>
				</AdminFormField>
